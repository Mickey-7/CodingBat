...
public class Map_1 {
    ...
    public Map<String, String> mapBully(Map<String,String> map){
        ...
        if (map.containsKey("a")) {
            //need to get the content of a first before setting tis value to ""
            map.put("b", map.get("a"));
            map.put("a", "");
        }
        return map;
    ...
    // If the values exist and have the same length, c
    // hange them both to the empty string in the map.
