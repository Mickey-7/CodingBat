...
public class Strings_1 {
    ...
    public String middleThree(String str){
        ...
        char[] word = {str.charAt(mid-1), str.charAt(mid), str.charAt(mid+1)};
    ...
    public boolean hasBad(String str){
        return str.startsWith("bad",0) || str.startsWith("bad",1) ? true : false;
    }
    ...
    public String atFirst(String str){
        return str.length()>1 ? str.substring(0,2) : str.length()==1 ? str+"@" : "@@";
    }
    ...
    public String lastChars(String a, String b){
        if (a.isEmpty() && b.isEmpty()){
            ...
            char[] word = {a.charAt(0),b.charAt(b.length()-1) };
            return new String(word);
        }
        else         if (a.isEmpty()){
    ...
    public String seeColor(String str){
        return str.startsWith("blue",0) ? "blue" : str.startsWith("red") ? "red" : "";
    }
    ...
    public String minCat(String a, String b){
        ...
        if (a.length() > b.length()){
            newString = a.substring( a.length() - b.length() );
            return newString.concat(b);
        }
        else {
            return new String(a.concat(b.substring( b.length() - a.length() )));
        }
    }
    ...
    public String withoutX(String str){
        ...
        else if (str.charAt(0)=='x' && str.length()==1){
            return str.substring(1);
        }
