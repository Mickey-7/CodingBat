...
//        same for the loop above
        ...
        for (int i = 0; i < a.length()-1; i+=2) {
            for (int j = 0; j < b.length()-1; j+=2) {
                if (a.substring(i,i+2).equals(b.substring(j,j+2))){
                    System.out.println(a.substring(i,i+2) +":"+ b.substring(j,j+2));
                    count++;
                }
            }
        }
    ...
    public String stringX(String str){
        ...
        if (str.startsWith("x",0) && str.endsWith("x")){
            String newString = "";
...
//                return str.substring(0,i)+str.substring();
            }
        }
        return str;
    ...
    public boolean has271(int[] nums){
        for (int i = 0; i < nums.length-1; i++) {
            if ((nums[i]==2 || nums[i]==3) && (nums[i+1]==7 || nums[i+1]==8) && (nums[i+2]==1 || nums[i+2]==2)){
                return true;
            }
        }
        return false;
